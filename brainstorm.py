...
def vig_e():
    ...
    e_key = input("Please enter eryption key: ")
    e_key = e_key.lower()
    ...
    print(rail_vig_d)
    finalstep=("Now that we encrypted Using vig and rail and decrypted the vige rail lets finish with getting our message by putting in the key and cipher")
    return(finalstep)
