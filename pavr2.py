...
st.image('key.jpg',caption=None, width=700)
...
if option == 'Encrypt':
    ...
    e_key = st.text_input("Now Lets Do Vig encryption of affine..playfair cipher enter any key and we will use your prevous encryption to encrypt further")
    e_key = e_key.lower()
...
vige = e_string
st.image('vigetxt.png', caption=None, width=800)
st.write("Your affine..Playfair..Vigenere cipher of your text is:")
rail_vig_e = ''
rail_vig_d = ''
rail_vig_e = (encryptRailFence(e_string, 3))
rail_vig_d = (decryptRailFence(rail_vig_e, 3))
st.image('railetxt.png', caption=None, width=800)
st.write("Your affine..playfair..vig..rail cipher is:")
st.write(rail_vig_e)
d_cryptall = st.text_input("Would you like to decrypt it all? (y/n)")
if d_cryptall == "y":
    st.image('raildtxt.png', caption=None, width=800)
    st.write("Your rail Decryption of your vig..playfair..affine cipher is:")
    st.write(rail_vig_d)
    st.write(
    ...
    # Takes erpytion key from user
    d_key = st.text_input("Please enter the right key: ")
    d_key = d_key.lower()

    # this is when the string is inputed
    input_string = st.text_input("Please enter the right cipher")
    input_string = input_string.lower()
    ...
    vigd = d_string.upper()
    st.image("vigdtxt.png", caption=None, width=800)
    st.write("Your rail..vig decryption of your ..playfair..affine cipher is")
    st.write(vigd)
text = st.text_input("Enter Text: ")
typeOfText = st.text_input("Is this plain text? (y/n) ")
key4 = st.text_input("Enter keyword: ")
key1 = st.text_input("Affine key1: ")
key2 = st.text_input("Affine key2: ")
...
if typeOfText == "y":
    ...
    st.write(affine_encrypt(affine, keyMatrix))
elif typeOfText == "n":
    # affine then Playfair
    playfair = affine_decrypt(text, keyMatrix)
    billy = PlayFairdecrypt(playfair, key4)
    st.image("affined.png", caption=None, width=600)
    st.write("Your Affine decryption is:")
    st.write(affine)
    st.image("playfaird.png", caption=None, width=600)
    st.write("Your Playfair decryption and Message is: \n ")

    st.write(billy)
st.write("THANK YOU HOPE YOUR ENJOYED!")
st.image('banner2.png')
from PIL import Image

image = Image.open('citadelstudios.png')
st.image(image, caption='CRYPTO PROJECT')
